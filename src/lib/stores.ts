...
export const spatialSelection: Writable<{hwId: number; originBinId: number; radius: number; startMousePos: {x: number, y: number}; selectionId: number; selection: SpatialSelection} | undefined> = writable(undefined);
