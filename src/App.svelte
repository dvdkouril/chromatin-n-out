<script lang="ts">
  ...
  // let selectionSecond = { start: 10, end: 20 };
  // let selectionThird = { start: 0, end: 2 };
  ...
  //   }
  //   if (colors === undefined) {
  //     colors = d3.quantize((t) => d3.interpolateSpectral(t * 0.8 + 0.1), elNum);
  //   }
  ...
  //     .join("path")
  //     // .attr("fill", "#bbbbbb")
  //     .attr("fill", (d) => (isInSelection(d.data) ? "blue" : color(N[d.data])))
  //     .attr("d", arc)
  ...
  //     selection = { start: selection.start, end: event.target.__data__.data };
  //     console.log(event);
  //   }
  // };
...
<div id="container">
  <SelectionWidget width={400} height={400} /> 
</div>
<main />
